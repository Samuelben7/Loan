...
from .views import (
    RegisterView, LoginView, ResetPasswordPageView, ActivateAccountView, EstatisticaMensalView, PasswordResetRequestView, LogoutView, gerar_pdf_enviar_email, EstatisticasEmprestimosView
)
